...
?>   
            ...
            <!-- Article -->
            <div style="text-align:center;padding-right: 400px;padding-bottom: 50px;padding-left: 400px;">
...
<td class="style3"><div align="left" class="style9 style5"><strong><a href="EditUser.php?username=<?php echo $UserName;?>">Edit</a></strong></div></td>
<td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteAdmin.php?username=<?php echo $UserName;?>">Delete</a></strong></div></td>
</tr>
<?php
}
