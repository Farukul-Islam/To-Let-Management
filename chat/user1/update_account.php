<?php
	...
	$myq=mysqli_query($conn,"select * from `user1` where userid='".$_SESSION['id']."'");
	...
	elseif ($cpassword!=$myqrow['password']){
		...
		mysqli_query($conn,"update `user1` set username='$musername', password='$newpassword', uname='$mname' where userid='".$_SESSION['id']."'");
		?>
		<script>
