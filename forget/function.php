...
function send_mail($to, $token)
{
	...
	$mail->SMTPAuth = true;
	$mail->Username = 'warford045@gmail.com';
	$mail->Password = '@Sohag1357';
	$mail->SMTPSecure = 'ssl';
	$mail->Port = 465;
	
	$mail->From = 'warford045@gmail.com';
	$mail->FromName = '@Sohag1357';
	$mail->addAddress($to);
	$mail->addReplyTo('@Sohag1357', 'Reply');
	
	$mail->isHTML(true);
	
	$mail->Subject = 'Demo: Password Recovery Instruction';
	$link = 'http:///forgot-password-recovery-script/forget.php?email='.$to.'&token='.$token;
