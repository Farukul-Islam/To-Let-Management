        ...
        <div class="row">
          ...
          <div class="col-md-10 col-md-offset-1">
            <div class="home-content">
              ...
              <p class="white-text"> An Exclusive Residence Solution
              </p>
              <br><br>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="about">
            ...
            <p>This website provides innovative, trustworthy and professional services to the users. </p>
        ...
        <div class="col-md-4">
          <div class="about">
            ...
            <p>We try our best to provide standard and secure residences for bachelors, families and also comfortable parking.</p>
        ...
        <div class="col-md-4">
          <div class="about">
            ...
            <p>In the Website, users can express their opinions about our services that we provide and also suggest us structural advices to improve our service.</p>
