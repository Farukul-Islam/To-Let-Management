    ...
    <nav id="nav" class="navbar nav-transparent">
      <div class="container">
        ...
        <ul class="main-nav nav navbar-nav navbar-right">
          <li class="active"><a href="ldhome.php">Home</a></li>
...
<div class="fk">
  ...
  <br><br><br><br>
  <h2>Welcome to Landlord Home Page</h2>

  <p>Welcome to our Website. Here, you can post your room/flat/parking renting ads. You have to give adequete information in description.</p>
</div>
